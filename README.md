...
新版增加 **Prompt Card / 提示词卡**。

每张成图都会配一份可复用的视觉提示词，重点不是堆参数，而是把这张图真正起作用的部分拆出来：

- **光感**：主光方向、逆光 / 侧光 / 窗光 / 树影、轮廓光与高光控制。
- **镜头**：景别、焦段感、镜头距离、机位、景深与前景关系。
- **质感**：真实摄影 / 电影截图方向、皮肤细节、对比度、暗部纯净度。
- **氛围**：风、发丝、微表情、雨滴、车流、反射、空气状态等。

示例：

```text
提示词：
年轻女生坐在午后阳光照进的家居沙发边，贴近镜头看向摄影机，嘴里含着透明粉色棒棒糖；侧前方真实窗光落在眼睛、鼻梁与脸颊，保留毛孔、唇纹与细小碎发，35mm 近距离大特写，浅景深，真实摄影质感，高光自然滚降，暗部干净，无油光、无脏颗粒。

拆解：
光：侧前方窗光，脸部局部硬光，室内环境反射补光。
镜头：35mm，大特写，约 40–50cm 距离。
质感：真实摄影，皮肤微纹理清楚，适中偏高对比，暗部纯净。
氛围：居家、松弛、轻微俏皮，碎发自然。
```

这样可以直接从成图反推和学习 **氛围、光感、镜头与人物状态**，也方便把同一套视觉语言迁移到 Midjourney、Banana、视频模型或其他工作流。
