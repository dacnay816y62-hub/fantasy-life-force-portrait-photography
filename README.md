...
MODE B 的默认审美更偏鲜明、明亮、亲密、高饱和、高对比。它会优先生成有镜头吸引力的女性人像，但不会固定成同一张网红脸，也不会把所有画面都做成同一种动作和场景。这里的“亲密”和“高饱和”必须是清爽的摄影语言，不能变成油亮、媚态、擦边或廉价网红修图。
...
- 不用滤镜替代摄影判断。
- 不追求整齐摆拍的 AI 广告图。
- 不做油腻审美：避免油亮皮肤、湿身诱惑、媚态姿势、夜店霓虹和擦边网红感。
